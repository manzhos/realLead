        ...
        : <>
            ...
            <Formik
              ...
              onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
                try {
                  values.submit = checked;
                  // console.log('values:', values)
                  const res = await request(`${API_URL}/user`, 'POST', {...values})
            ...
            >
              {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                <form noValidate onSubmit={handleSubmit} {...others}>
                  ...
                  <Box sx={{ mt: 2 }}>
                    <AnimateButton>
                      <Button disableElevation disabled={!checked} fullWidth size="large" type="submit" variant="contained" color="secondary">
                        Sign up
                      </Button>
                    </AnimateButton>
                  </Box>
